...
- QA found that the Add Lead modal can close when the tester switches tabs/windows to copy test data. Dashboard Lovable handoff 018 asks for a focused modal persistence fix.
